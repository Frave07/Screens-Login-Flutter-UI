            ...
            Stack(
              children: [
                ...
                Positioned(
                  ...
                  child: Row(
                    children: [
                      Text('Login ', style: GoogleFonts.getFont('Inter', color: Colors.white, fontSize: 17)),
                      GestureDetector(
                        child: Text('/ Sign Up', style: GoogleFonts.getFont('Inter', color: Colors.white, fontSize: 25))
                      ),
                    ],
                  )
                ),
